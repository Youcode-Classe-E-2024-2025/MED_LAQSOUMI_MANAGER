...
<html lang="en">
  ...
  <body class="h-screen w-screen bg-black flex items-center justify-center text-gray-100">
    ...
    <div class="flex w-full max-w-6xl h-[90vh] bg-black shadow-lg rounded-lg overflow-hidden">
      ...
      >
        <div class="absolute inset-0 flex flex-col items-center justify-center text-yellow-300 m-10">
      ...
      <div class="w-full md:w-1/2 flex items-center justify-center m-auto p-10">
        <div class="w-full animated-form">
          ...
          <!-- Login Form -->
          <form id="login-form" action="src/auth/login.php" method="POST" style="display: block">
    <h2 class="text-3xl font-bold text-yellow-400 text-center mb-6">Login</h2>
    <div class="space-y-4">
        <div>
            <label for="email-login" class="fa-solid fa-envelope block mb-2 ml-2 text-yellow-500"></label>
            <input
                type="email"
                id="email-login"
                name="email"
        ...
        >
          ...
          <!-- Registration Form -->
          <form id="register-form" action="./src/auth/login.php" style="display: none">
